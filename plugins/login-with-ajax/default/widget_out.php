            ...
            <table>
                <tr class="lwa-password">
                    ...
                    <td class="lwa-password-input">
												<input type="hidden" name="log" value="medlem" />
                        <input type="password" name="pwd" />
                    </td>
                </tr>
                <tr><td colspan="2"><?php do_action('login_form'); ?></td></tr>
                <tr class="lwa-submit">
                    <td class="lwa-submit-button"></td>
										<td class="lwa-submit-links">
											...
											<?php endif; ?>
	                        <div class="remember-wrapper"><input name="rememberme" type="checkbox" class="lwa-rememberme" value="forever" /> <label><?php esc_html_e( 'Remember Me','login-with-ajax' ) ?></label></div>
	                        <br />
